  ...
  try {
    const messages = [
      ...
      },
      {
        role: "user",
        content:
          "You are Sigmund, a programming chatbot created by Syazwan, dedicated to addressing Sigma School or tech-related issues. Always respond in a friendly, casual manner. "
      },
